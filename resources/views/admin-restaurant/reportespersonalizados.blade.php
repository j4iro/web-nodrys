...
<script type="text/javascript">
    ...
    function filtrar()
    {
        fechaini = $('#fecini').val();
        fechafin = $('#fecfin').val();
        var finalUrl = {!! json_encode(url('/')) !!}+ "/admin-restaurante/reportes-personalizados/get/" + $('#fecini').val() +"/" + $('#fecfin').val() +'/' +  false ;
    ...
    function descargarPDF()
    {
        fechaini = $('#fecini').val();
        fechafin = $('#fecfin').val();
        var finalUrl = {!! json_encode(url('/')) !!}+ "/admin-restaurante/reportes-personalizados/get/" + $('#fecini').val() +"/" + $('#fecfin').val() + '/' + true ;
        // console.log(finalUrl);
        // $.get(finalUrl,function(data){});
